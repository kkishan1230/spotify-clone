    ...
    <section className="p-4 space-y-8 pr-8">
      <div className="flex space-x-2 items-center justify-between">
        <div className="flex items-center space-x-4 border-2 border-[#262626] rounded-full h-12 py-3 px-4">
          <ShieldCheckIcon className="text-[#CCCCCC] text-xl h-6 cursor-pointer" />
          <Cog6ToothIcon className="text-[#CCCCCC] text-xl h-6 cursor-pointer" />
          <div>
            <BsFillBellFill className="text-[#CCCCCC] text-xl cursor-pointer" />
          </div>
        </div>
        <Dropdown />
      </div>
      <div className="bg-[#0D0D0D] border-2 border-[#262626] p-4 rounded-xl space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Squares2X2Icon className="text-[#686868] h-6" />
        </div>
